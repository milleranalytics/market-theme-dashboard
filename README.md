...
- **Today prices:** Alpaca consolidated SIP snapshots delayed by 15 minutes.
- **Historical returns:** adjusted consolidated SIP daily bars for 1W, 1M, 3M, and YTD.
...
ALPACA_SNAPSHOT_FEED=delayed_sip
ALPACA_HISTORY_FEED=sip
```
...
- Today's returns use consolidated SIP snapshots delayed by 15 minutes. Historical returns and relative strength use consolidated SIP daily bars through the free plan's 15-minute availability boundary.
