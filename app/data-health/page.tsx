    ...
    <main className="health-shell">
      ...
      <section className="source-panel">
        ...
        <div className="health-note">
          ...
          <span>GitHub downloads and validates the issuer files once each weekday after the market closes. The dashboard checks the <a href={GITHUB_SNAPSHOT_URL}>latest normalized snapshot</a> when it opens and uses its bundled copy only if GitHub is unavailable.</span>
        </div>
